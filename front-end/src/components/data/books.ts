...
export const mockBooks: Book[] = [
  ...
  },
  {
    ...
    author: "Alma Katsu",
    description:
      "True love can last an eternity… but immortality comes at a price. On the midnight shift, Dr. Findley is expecting another quiet evening. But when Lanore McIlvrae enters his ER, she changes his life forever.",
  ...
  },
  {
    ...
    description:
      "Thirty-two minutes for one world to die, another to be born. An epic chronicle of human endurance in the face of unprecedented catastrophe and unimaginable danger.",
  ...
  },
  {
    ...
    description:
      "A young adult adventure-romance about a teenage girl who falls in love with a vampire.",
    genre: "Supernatural",
    longDescription:
  ...
  },
  {
    ...
    author: "Jay Kristoff",
    description:
      "A story of a warrior who fights the darkness in a world where the sun has been dimmed and Vampires walk the earth, preying endlessly on humanity.",
    genre: "Dark Fantasy",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Sonea, a young girl from the slums, discovers her latent magical potential and finds herself on the run from the powerful Magicians' Guild.",
    genre: "Fantasy",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Into this tumultuous time is born a child for whom the the world has been waiting, one with the power to change the world - for good, or for evil ...",
    genre: "Fantasy",
    longDescription:
  ...
  },
  {
    ...
    author: "Alma Katsu",
    description:
      "A bone-chilling mix of historical record and visceral horror pits a group of increasingly desperate pioneers against the unknown dangers of the Old West.",
    genre: "Horror",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Unknown bones, untold secrets, and unsolved crimes from the  distant past cast ominous shadows on the present.",
    genre: "Thriller",
    longDescription:
